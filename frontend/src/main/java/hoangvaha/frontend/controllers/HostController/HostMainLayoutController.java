...
import hoangvaha.frontend.controllers.ManagerController.ManagerNavBarController;
...
public class HostMainLayoutController {
    @FXML
    private StackPane contentArea;

    @FXML
    private HostNavBarController navBarController;
